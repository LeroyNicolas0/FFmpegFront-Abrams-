...
public enum Extension {
	...
	//Video
	MP4("mp4","MPEG-4 Part 14",new VCodec[]{VCodec.ALL},new ACodec[] {ACodec.AAC,ACodec.MP3LAME}),
	GP("3gp","3GPP file format",new VCodec[]{VCodec.LIBX264,VCodec.LIBXVID,VCodec.NONE},new ACodec[] {ACodec.AAC}),
	G2("3g2","3GPP2 file format",new VCodec[]{VCodec.LIBX264,VCodec.LIBXVID,VCodec.NONE},new ACodec[] {ACodec.AAC}),
	MKV("mkv","Matroska",new VCodec[]{VCodec.ALL},new ACodec[] {ACodec.ALL}),
	AVI("avi", "Audio Video Interleaved",new VCodec[]{VCodec.LIBXVID,VCodec.NONE},new ACodec[] {ACodec.MP3LAME}),
	//Sous-Titres 
